...
$routes = [
    ...
    'admin/newsletters/toggle-schedule/(\d+)' => ['controller' => 'NewsletterController', 'action' => 'toggleSchedule'],
    'admin/newsletters/get-schedule/(\d+)' => ['controller' => 'NewsletterController', 'action' => 'getSchedule'],
    'admin/newsletters/subscribers' => ['controller' => 'NewsletterController', 'action' => 'subscribers'],
    'admin/newsletters/subscribers/add' => ['controller' => 'NewsletterController', 'action' => 'addSubscriber'],
    'admin/newsletters/subscribers/update/(\d+)' => ['controller' => 'NewsletterController', 'action' => 'updateSubscriber'],
    'admin/newsletters/subscribers/unsubscribe/(\d+)' => ['controller' => 'NewsletterController', 'action' => 'unsubscribeSubscriber'],
    'admin/newsletters/subscribers/resubscribe/(\d+)' => ['controller' => 'NewsletterController', 'action' => 'resubscribeSubscriber'],
    'admin/newsletters/subscribers/delete/(\d+)' => ['controller' => 'NewsletterController', 'action' => 'deleteSubscriber'],
    'newsletter/subscribe' => ['controller' => 'NewsletterController', 'action' => 'subscribe'],
    'admin/newsletters/update-schedule/(\d+)' => ['controller' => 'NewsletterController', 'action' => 'updateSchedule'],
    'admin/newsletters/export-schedules' => ['controller' => 'NewsletterController', 'action' => 'exportSchedules'],
    ...
    'settings/backups/delete/(.+)' => ['controller' => 'SettingsController', 'action' => 'deleteBackup'],
    ...
    'mpesa-verification/verify-group/([^/]+)' => ['controller' => 'MpesaVerificationController', 'action' => 'verifyGroup'],
    'mpesa-verification/verify-all' => ['controller' => 'MpesaVerificationController', 'action' => 'verifyAll'],
    ...
    'airbnb/booking-confirmation/([A-Za-z0-9]+)/download-receipt' => ['controller' => 'AirbnbPublicController', 'action' => 'downloadReceipt'],
    ...
    'agent/clients/delete/(\d+)' => ['controller' => 'AgentClientsController', 'action' => 'delete'],
