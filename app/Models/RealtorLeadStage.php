...
class RealtorLeadStage extends Model
{
    protected $table = 'realtor_lead_stages';
    ...
    {
        $sql = "CREATE TABLE IF NOT EXISTS realtor_lead_stages (
    ...
    private function ensureDefaults()
    {
        ...
        $defaults = [
            ...
            ['stage_key' => 'contacted', 'label' => 'Qualified', 'color_class' => 'warning', 'sort_order' => 20, 'is_won' => 0, 'is_lost' => 0],
            ['stage_key' => 'won', 'label' => 'Won', 'color_class' => 'success', 'sort_order' => 30, 'is_won' => 1, 'is_lost' => 0],
            ['stage_key' => 'lost', 'label' => 'Lost', 'color_class' => 'danger', 'sort_order' => 40, 'is_won' => 0, 'is_lost' => 1],
        ];
