...
<head>
    ...
    <link href="<?= BASE_URL ?>/public/assets/css/style.css?v=11" rel="stylesheet">
...
<body>
        ...
        <nav class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <?php if ($isAdmin && !$isImpersonating): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= (strpos($_SERVER['REQUEST_URI'], '/admin/subscriptions/plans') !== false) ? 'active' : '' ?>" href="<?= BASE_URL ?>/admin/subscriptions/plans">
                            <i class="bi bi-award"></i>
                            <span>Subscription Plans</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= (strpos($_SERVER['REQUEST_URI'], '/admin/subscriptions/active') !== false) ? 'active' : '' ?>" href="<?= BASE_URL ?>/admin/subscriptions/active">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= (strpos($current_uri, 'admin/payments/overdue') === 0) ? 'active' : '' ?>" href="<?= BASE_URL ?>/admin/payments/overdue">
                            <i class="bi bi-exclamation-circle me-2"></i> Overdue Payments
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      <?php if (isset($_SESSION['flash_message'])): ?>
        <?php
          $flashMsg = (string)($_SESSION['flash_message'] ?? '');
          $isLoggedIn = isset($_SESSION['user_id']);
          $isAuthNotice = stripos($flashMsg, 'please login') !== false;
        ?>
        <?php if (!($isLoggedIn && $isAuthNotice)): ?>
          const __flashHtml = <?= json_encode(nl2br($flashMsg)) ?>;
          Swal.fire({
