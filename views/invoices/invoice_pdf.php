...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .content { background: #f9fafb; padding: 18px 28px 14px 28px; }
    ...
    .dark-title { font-size: 11px; font-weight: 900; letter-spacing: 1px; text-transform: uppercase; color: #f59e0b; margin: 0 0 10px; }
    ...
    .dark-value { font-size: 12.5px; font-weight: 700; color: #fff; word-break: break-word; overflow-wrap: anywhere; }
    .dark-small { font-size: 12px; color: rgba(229,231,235,0.9); word-break: break-word; overflow-wrap: anywhere; }
