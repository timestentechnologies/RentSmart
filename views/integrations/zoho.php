...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            ...
            <p class="text-muted">Automatically sync your payments and expenses to Zoho Books</p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="card border-warning">
                ...
                <div class="card-body">
                    <p class="mb-3">Please configure your Zoho Books credentials to start syncing data.</p>

                    <form method="POST" action="<?= BASE_URL ?>/integrations/zoho/config">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">Client ID</label>
                                <input type="text" name="client_id" class="form-control" placeholder="1000.ABCDEFGH...">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="refresh_token" class="form-control" placeholder="1000.12345...">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Organization ID</label>
                                <input type="text" name="organization_id" class="form-control" placeholder="123456789">
                            </div>
                        </div>
                        <div class="mt-3">
            ...
            <div class="card border-success">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <p class="mb-2"><strong>Organization ID:</strong> <?= $organizationId ?? 'Not set' ?></p>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-primary">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text">Create invoices and record payments in Zoho Books</p>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-warning">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text">Create expense records in Zoho Books</p>
...
async function syncPayments() {
    try {
        ...
        const response = await fetch('<?= BASE_URL ?>/integrations/zoho/sync-payments', {
            method: 'POST',
            headers: {
        ...
        if (data.success) {
            Swal.fire({
                icon: 'success',
                title: 'Sync Complete!',
                html: `Successfully synced <strong>${data.synced}</strong> payments to Zoho Books`,
...
async function syncExpenses() {
    try {
        ...
        const response = await fetch('<?= BASE_URL ?>/integrations/zoho/sync-expenses', {
            method: 'POST',
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            }
        ...
        if (data.success) {
            Swal.fire({
                icon: 'success',
                title: 'Sync Complete!',
                html: `Successfully synced <strong>${data.synced}</strong> expenses to Zoho Books`,
                confirmButtonText: 'OK'
            }).then(() => {
                location.reload();
            });
