...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= BASE_URL ?>/terms">Terms</a></li>
    ...
    <div class="policy-content">
        <div class="container">
            ...
            <?php
            $termsBodyDefault = '<p class="lead">Last updated: ' . date('F d, Y') . '</p>'
            ...
            echo site_setting('terms_body_html', $termsBodyDefault);
            ?>
        </div>
    </div>
