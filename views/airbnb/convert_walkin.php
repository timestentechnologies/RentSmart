...
<div class="container-fluid pt-4">
    ...
    <div class="card page-header mb-4">
        <div class="card-body d-flex justify-content-between align-items-center">
            <h1 class="h3 mb-0">Convert Walk-in to Booking</h1>
    ...
    <div class="card mb-4 bg-light">
        <div class="card-body">
            <h5 class="card-title">Original Walk-in Inquiry</h5>
            <div class="row">
                <div class="col-md-3">
                    <strong>Guest:</strong> <?php echo htmlspecialchars($preselectedGuest['guest_name']); ?><br>
                    <small class="text-muted"><?php echo htmlspecialchars($preselectedGuest['guest_phone']); ?></small>
                </div>
                <div class="col-md-3">
                    <strong>Property:</strong> <?php echo htmlspecialchars($preselectedGuest['property_name']); ?>
                </div>
                <div class="col-md-3">
                    <strong>Preferred Dates:</strong><br>
                    <?php if ($preselectedGuest['preferred_check_in']): ?>
                        <?php echo date('M d', strtotime($preselectedGuest['preferred_check_in'])); ?> - 
                        <?php echo date('M d', strtotime($preselectedGuest['preferred_check_out'])); ?>
                    <?php else: ?>
                        <span class="text-muted">Not specified</span>
                    <?php endif; ?>
                </div>
                <div class="col-md-3">
                    <strong>Budget:</strong> <?php echo htmlspecialchars($preselectedGuest['budget_range'] ?? 'Not specified'); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo BASE_URL; ?>/airbnb/bookings/store" id="bookingForm">
                <input type="hidden" name="walkin_guest_id" value="<?php echo $preselectedGuest['id']; ?>">
                ...
                <div class="row">
                    <!-- Guest Information (Pre-filled from walk-in) -->
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Guest Name <span class="text-danger">*</span></label>
                        <input type="text" name="guest_name" class="form-control" value="<?php echo htmlspecialchars($preselectedGuest['guest_name']); ?>" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Guest Phone <span class="text-danger">*</span></label>
                        <input type="tel" name="guest_phone" class="form-control" value="<?php echo htmlspecialchars($preselectedGuest['guest_phone']); ?>" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Guest Email</label>
                        <input type="email" name="guest_email" class="form-control" value="<?php echo htmlspecialchars($preselectedGuest['guest_email'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="check_in_date" id="check_in_date" class="form-control" 
                            value="<?php echo $preselectedGuest['preferred_check_in']; ?>" required>
                    </div>
                    <div class="col-md-3 mb-3">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="check_out_date" id="check_out_date" class="form-control" 
                            value="<?php echo $preselectedGuest['preferred_check_out']; ?>" required>
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="guest_count" class="form-control" value="<?php echo $preselectedGuest['guest_count']; ?>" min="1">
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="special_requests" class="form-control" rows="3"><?php echo htmlspecialchars($preselectedGuest['requirements'] ?? ''); ?></textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Internal Notes</label>
                        <textarea name="internal_notes" class="form-control" rows="3">Converted from walk-in guest #<?php echo $preselectedGuest['id']; ?>. Original notes: <?php echo htmlspecialchars($preselectedGuest['notes'] ?? ''); ?></textarea>
                    </div>
                </div>

                <div class="d-flex justify-content-between">
                    <a href="<?php echo BASE_URL; ?>/airbnb/walkin-guests" class="btn btn-outline-secondary">Cancel</a>
                    <button type="submit" class="btn btn-success">Create Booking & Convert Walk-in</button>
                </div>
            </form>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const preselectedUnitId = <?php echo json_encode($preselectedUnitId); ?>;
                ...
                .then(data => {
                    if (data.success && data.units) {
                        data.units.forEach(unit => {
                            ...
                            if (preselectedUnitId && unit.id == preselectedUnitId) {
                                option.selected = true;
                                pricePerNight.value = unit.base_price;
                                calculateTotals();
                            }
